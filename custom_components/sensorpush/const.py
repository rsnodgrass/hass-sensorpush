...
CONF_MAXIMUM_AGE = (
    'maximum_age'  # maximum age (in minutes) of observations before they expire
)
...
MEASURES = {
    MEASURE_TEMP: {NAME: 'Temperature', ICON: 'mdi:thermometer'},
    MEASURE_HUMIDITY: {  # Relative Humidity (Rh %)
        NAME: 'Humidity',
        ICON: 'mdi:water-percent',
    },
    MEASURE_DEWPOINT: {NAME: 'Dewpoint', ICON: 'mdi:thermometer'},
    MEASURE_BAROMETRIC_PRESSURE: {NAME: 'Barometric Pressure', ICON: 'mdi:nature'},
    MEASURE_VPD: {NAME: 'Vapor Pressure Deficit', ICON: 'mdi:thermometer'},
}
